<?php 
    ...
    class Shop extends CI_Controller{
        ...
        public function typelist(){
            ...
            $this->load->view('admin/shop/typeList.php',array('type'=>$res));
        ...
        public function edittype(){
            ...
            $this->load->view('admin/shop/editType.php',array('type'=>$res[0]));
            $this->load->view('admin/foot.php');
        }
        public function  addtype(){
            ...
            $this->load->view('admin/shop/addType.php',array('type'=>$resarr));
            $this->load->view('admin/foot.php');
        }
        ...
        public function doaddType(){
            ...
            if($this->form_validation->run() == true){
                ...
                if($res){
                    $this->load->view("admin/notice.php",array('url'=>"/admin/shop/typelist?pid=0",'msg'=>'分类添加成功','status'=>'1'));
                }else{
                    $this->load->view("admin/notice.php",array('url'=>"/admin/shop/addtype",'msg'=>"分类添加失败\r\n联系管理员",'status'=>'0'));
                }
            }else{
                $msg=validation_errors();
                $this->load->view("admin/notice.php",array('url'=>"/admin/shop/addtype",'msg'=>$msg,'status'=>'0'));
            }
        }
        public  function doeditType(){
            ...
            if($this->form_validation->run() == true){
                ...
                if ( ! $this->upload->do_upload('img'))
                {
                    ...
                    $this->load->view("admin/notice.php",array('url'=>"/admin/shop/edittype?id={$id}",'msg'=>$msg,'status'=>'0'));
                }
                else
                {
                    ...
                    if($this->db->update('zs_classtype',$data)){
                        $this->load->view("admin/notice.php",array('url'=>"/admin/shop/typelist?pid=0",'msg'=>'分类信息修改成功','status'=>'1'));
                    }else{
                        $this->load->view("admin/notice.php",array('url'=>"/admin/shop/edittype?id={$id}",'msg'=>"信息修改失败\r\n联系管理员",'status'=>'0'));
                    }
